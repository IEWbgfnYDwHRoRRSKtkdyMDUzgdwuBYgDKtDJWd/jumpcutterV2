...
mergeCommand = "ffmpeg -i spedup.mp4  -i spedupAudio.wav  -c:v h264_nvenc -rc:v vbr_hq -cq:v 36 -b:v 500k -maxrate:v 1000k -profile:v high -c:a aac -an -threads 0 out_{}".format(videoFile)
